...
def main(unused_argv):
    ...
    for buffer in sentences:
        ...
        while True:
            ...
            train_data.append(np.concatenate(concat))
            ...
            if len(stack) >= 2 and stack[-1].parent == stack[-2].index:
                ...
                train_labels.append(label_id[stack[-1].label] + len(label_id) * 0 + 1)
                ...
                train_labels.append(label_id[stack[-1].label] + len(label_id) * 1 + 1)
